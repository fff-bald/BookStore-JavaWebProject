	...
	<script type="text/javascript"> $(function () {
		...
		$(".updateCount").change(function () {
			...
			if ( confirm("你确定要将【" + name + "】商品修改数量为：" + count + " 吗?") ) {
				//发起请求。给服务器保存修改
				location.href = "${pageScope.basePath}/bookstore/cartServlet?action=updateCount&count="+count+"&id="+id;
			} else {
...
<body>
	...
	<div id="main">
		...
		<table>
			...
			<c:if test="${not empty sessionScope.cart.items}"> <%--如果购物车非空的情况--%>
		...
		<div class="cart_info">
			...
			<span class="cart_span">总金额
				<span class="b_price">
					${empty sessionScope.cart.totalPrice?0:sessionScope.cart.totalPrice}
				</span>元
			</span>
